...
<body>
  ...
  <form method="post" action="admin.php" id="admin_form" class="login-form" onsubmit="fun();" autocomplete="off" role="main">
    ...
    <div>
      ...
      <label class="label-email">
        <span id="err1"></span>
        <input type="text" class="text" name="user_name" id="user_name" onblur="chk(this.value);"placeholder="Enter Admin Name" tabindex="1" required />
    ...
    <div>
      <label class="label-password">
        <span id="err1"></span>
        <input type="text" class="text" name="password" id="password" onblur="chk1(this.value);" placeholder="Password" tabindex="2" required />
...
function fun() {
  ...
  var mil = document.getElementById("user_name").value;;
...
alert("Correct Admin Name");
  //  document.querySelector('#user_name"').classList.add('errorpop');

  //  document.getElementById("err1").innerHTML = "Not Valid Email Address";
...
var val = Number(12345678);

            if (admin_form.password.value == val) {
              ...
              //  document.getElementById("err2").innerHTML = "Not Valid Password";
