...
<form  action="feedback_handler.php" id="feedback_form" name="feedback_form"  method="post" enctype="multipart/form-data">
  ...
  <div class="wrapper centered">
    <article class="letter">
      <div class="side">
        <h1>FeedBack</h1>
        <p>
          <textarea name="feedback" placeholder="start from here"></textarea>
        </p>
      </div>
      <div class="side">
        <p>
        ...
        <p>
          <input type="email" name="email" placeholder="Your email" value=" <?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>" >
        </p>
        <p>
          <button id="sendLetter" name="btn_feed">Send</button>
          
          <!-- <input type="submit" name="btn_feed" value="SEND" id="btnfeed" class="btn btn-info col-lg-12">&nbsp; -->
      
        <button style="font-size:16px;margin-top:15px;color:white;"><a href="http://localhost/lib/index.html" style="color:white;">Home</a></button>
</p>
