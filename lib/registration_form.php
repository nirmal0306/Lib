    ...
    <div class="container">
        ...
        <div class="container  col-lg-9 col-md-11 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 col-xs-offset-0  "
            ...
            <div class="jumbotron login3 col-lg-10 col-md-11 col-sm-12 col-xs-12">
                ...
                <p class="page-header" style="text-align: center">Registration Form</p>
                ...
                <div class="container">
                    ...
                    <form class="form-horizontal" action="registration_handler.php" id="registration_form"
                        name="registration_form" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="user_first_name" name="user_first_name"
                                    placeholder="First name" onblur="chk(this.value);" required>
                                    <span id="err1"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="user_middle_name" name="user_middle_name"
                                    placeholder="Middle name" onblur="chk1(this.value);" required>
                                    <span id="err2"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="user_last_name" name="user_last_name"
                                    placeholder="Last name" onblur="chk2(this.value);" required>
                                    <span id="err3"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="phone_no" name="phone_no"
                                    placeholder="phone" id="password" onblur="chk4(this.value);" required>
                                    <span id="err5"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <br /> <input class="form-control" id="address" name="address" type="text"
                                    placeholder="enter address" onblur="chk5(this.value);" required/>
                                    <span id="err6"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select onChange="getdistrict(this.value);" name="select_state" id="select_state" onblur="chk6(this.value);" required>
                        ...
                        <div class="form-group">
                            ...
                            <label for="select_district" class="col-sm-2 control-label">District:</label>
                            <div class="col-sm-10">
                                <select name="select_district" id="select_district" onblur="chk7(this.value);" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Email"
                                    onBlur="checkEmailAvailability();" required><span id="email-availability-status"
                     ...
                     <input type="hidden" class="form-control" name="money_owed" placeholder="Money" id="password" required value="null"> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" onblur="chk12(this.value);" required>
                                <span id="err13"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" name="file" id="file" placeholder="Upload image"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-4 col-sm-5">
                                <input type="submit" name="btn_register" value="REGISTER" id="btnSubmit"
                                    class="btn btn-info col-lg-12">&nbsp;
                                <input type="reset" value="RESET" id="btnReset" class="btn btn-info col-lg-12">&nbsp;
